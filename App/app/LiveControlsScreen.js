      ...
      {videoAvailable ? (
        <View style={styles.videoContainer}>
          <WebView
            ...
            style={StyleSheet.absoluteFillObject}
            onError={() => {
              showBanner('Video not available');
        ...
        <View style={styles.noVideoContainer}>
          <Text style={styles.noVideoText}>No Camera Connected</Text>
        </View>
      )}

      {/* Controls hamesha visible rahenge */}
      <View style={styles.controlsContainer} pointerEvents="box-none">
        <View style={styles.joyArea} pointerEvents="box-none">
          <Joystick size={120} knobSize={60} onDirection={handleDirection} />
        </View>
        ...
        <View style={styles.armArea} pointerEvents="box-none">
          ...
          <View style={styles.armRow}>
            <Text style={styles.motorLabel}>Base</Text>

            <TouchableOpacity
              style={styles.armBtn}
              onPressIn={() => handleArm('base', 'cw')}
              onPressOut={() => handleArm('base', 'stop')}
            >
              <Text style={styles.btnText}>↺</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.armBtn}
              onPressIn={() => handleArm('base', 'ccw')}
              onPressOut={() => handleArm('base', 'stop')}
            >
              <Text style={styles.btnText}>↻</Text>
            </TouchableOpacity>
          ...
          {/* Arm Servo */}
          <View style={styles.armRow}>
            <Text style={styles.motorLabel}>Arm</Text>
            <TouchableOpacity
              style={styles.armBtn}
              onPressIn={() => handleArm('arm', 'down')}
              onPressOut={() => handleArm('arm', 'stop')}
            >
              <Text style={styles.btnText}>↑</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.armBtn}
              onPressIn={() => handleArm('arm', 'up')}
              onPressOut={() => handleArm('arm', 'stop')}
            >
              <Text style={styles.btnText}>↓</Text>
            </TouchableOpacity>
